...
function HamburgerMenu({ showMenu, setShowMenu }) {
  const styleMenuLines = useMemo(
    () => "bg-[#404040] w-7 h-[3px] rounded-full transition-all duration-200",
    []
  );
  ...
  return (
    <div
      ...
      className="absolute left-4 flex flex-col fcc h-8 gap-y-1 transition-all duration-300 lg:hidden"
      role="button"
      tabIndex={0}
    >
      <div
