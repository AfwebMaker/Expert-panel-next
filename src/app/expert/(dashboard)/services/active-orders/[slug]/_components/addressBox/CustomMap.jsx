...
const CustomMap = ({ text, setText, mapLocation }) => {
  ...
  return (
    <div className="relative w-full h-[400px] rounded-lg overflow-hidden fcc mt-5">
      ...
      {
        center && (
          <Link href={getMapUrl(center[0], center[1])} className="bg-transparent w-full h-full absolute top-0 right-0 z-20"></Link>
        )
      }
    </div>
  );
