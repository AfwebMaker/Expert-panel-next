    ...
    return (
        <div className='w-full'>
            <div className='w-full fcc flex-col'>
                <svg className='w-[60px] h-[60px] sm:w-[80px] sm:h-[80px]' xmlns="http://www.w3.org/2000/svg" width="80" height="81" viewBox="0 0 80 81" fill="none">
                ...
                <div className='fcc flex-col '>
                    <span className='font-medium text-base sm:text-2xl text-cf-400 text-center my-4'>
                        اطلاعات شما با موفقیت ثبت شد.
                    </span>
                    <span className='text-center mb-4 text-xs sm:text-sm text-cf-300'>ثبت نام شما با موفقیت انجام شد.</span>
                </div>
            </div>
