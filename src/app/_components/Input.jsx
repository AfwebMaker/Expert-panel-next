...
function Input({ active, state, title, placeholder, type, className }) {
  ...
  return (
    <div onClick={() => { active && setFocus(true) }} className={`bg-white h-[60px] relative fcc flex-col rounded-md overflow-hidden ${(value !== '' || focus) ? 'ring-primary-500 ring-2' : 'ring-cf-200 ring-1'} ${className}`}>
